    ...
    public static void main(String[] args) {
        ...
        while (!ord[0].equals("a")) {
            ...
            try {
                ...
                MonitorUtvei utveier = l.finnUtveiFra(startKol, startRad);
                if (utveier.stoerrelse() != 0) {
                    for (String s : utveier.hentListen()) {
                        System.out.println(s);
                        if(args.length > 1){//hviser detalijer, altså å skriveut stegene i letingen etter en utvei
                            args[1] = "detalje";
                            System.out.println(s);
                       }
                    }
                    System.out.println("\nAntall Utvei:" + utveier.stoerrelse()); //viser antall utveier
                }else {
